      ...
      <div className="flex-center" style={{ flexDirection: "column" }}>
        ...
        >
          ...
          >
            ...
            >
              Sou Edson Cândido Alves Júnior, um desenvolvedor Full Stack
              apaixonado por desafios. Com residência em Natal - RN, busco
              constantemente evoluir minhas habilidades em arquitetura de
              software e novas tecnologias.
            </p>
            <p
              style={{
                fontSize: "1.1rem",
            ...
            >
              Tenho foco em criar soluções que impactam, utilizando PHP, Java,
              Spring Boot, Node.js e React. Valorizo código limpo, performance e
              a entrega de valor real aos usuários.
            </p>
