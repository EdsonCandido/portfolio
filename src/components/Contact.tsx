  ...
  return (
    <section id="contact" className="section-padding container">
      ...
      >
        ...
        >
          Estou sempre aberto a novas oportunidades e desafios. Se você tem um
          projeto em mente ou quer apenas dar um oi, envie uma mensagem!
        </p>
        ...
        <div style={{ marginTop: "3rem", textAlign: "center" }}>
          ...
          >
            <FiMail /> edson.c.a.j@hotmail.com
          </a>
        </div>
      </div>
    </section>
